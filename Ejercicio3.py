...
print(f'Peso del paquete')
cant_pa = int(input(f'\n Ingrese la cantidad de payasos vendidos en el pedido: '))
cant_mu = int(input(f'\n Ingrese la cantidad de muñecas vendidos en el pedido: '))

payaso = 112
muñeca= 75

peso_total=(cant_pa*payaso)+(cant_mu*muñeca)
